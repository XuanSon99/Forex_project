            ...
            <div class="uk-width-3-4@m uk-margin-medium-bottom">
              ...
              <p>
                ...
                <a href="#"
                  ...
                  ><span class="uk-text-lowercase">@yourcompany</span></a
                >
              </p>
            </div>
          </div>
            ...
            >
              <div>
                <div class="in-timeline-branch">
                  <div class="uk-flex">
                    <i
                      class="fas fa-clipboard-check fa-lg in-icon-wrap circle primary-color"
                    ></i>
                    <div class="in-timeline-title uk-flex uk-flex-middle">
                      <h4 class="uk-margin-remove-bottom">Q4 2019</h4>
                      <span
                        class="uk-label uk-label-success uk-text-small uk-border-rounded"
                        >completed</span
                      >
                    </div>
                  </div>
                ...
                <div class="uk-box-shadow-small uk-width-expand">
                  <div
                    class="uk-card uk-card-default uk-card-body uk-card-small uk-border-rounded"
                  >
              ...
              <div>
                <div class="in-timeline-branch">
                  <div class="uk-flex">
                    <i
                      class="fas fa-cog fa-lg in-icon-wrap circle primary-color"
                    ></i>
                    <div class="in-timeline-title uk-flex uk-flex-middle">
              ...
              <div>
                <div class="in-timeline-branch">
                  <div class="uk-flex">
                    <i
                      class="fas fa-flask fa-lg in-icon-wrap circle primary-color"
                    ></i>
                    <div class="in-timeline-title uk-flex uk-flex-middle">
                      <h4 class="uk-margin-remove-bottom">Q3 2020</h4>
                      <span
                        class="uk-label uk-label-warning uk-text-small uk-border-rounded"
                        >planned</span
                      >
                    </div>
                  </div>
                ...
                <div class="uk-box-shadow-small uk-width-expand">
                  ...
                  >
                    <ul class="uk-list uk-list-bullet in-list-check">
                      ...
                      <li>
                        Community formation and the subsequent cyclic completion
                        of the product based on the wishes of customers
                      </li>
                    </ul>
                  </div>
                </div>
