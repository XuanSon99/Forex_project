<template>
  <div class="home">
            ...
            <div class="uk-container">
              <div class="uk-grid" data-uk-grid>
                <div class="uk-width-1-2@m">
                  <div class="uk-overlay">
                    <h1>
                      Let top <span class="in-highlight">traders</span> do the
                      job for you!
                    </h1>
                    <p class="uk-text-lead uk-visible@m">
                      Covesting allows you to automatically copy top performing
                      traders and achieve the returns
                    </p>
                    <div class="in-slideshow-button">
                      <a
                        href="#"
              ...
              <div class="uk-child-width-1-4" data-uk-grid>
                <div class="uk-flex uk-flex-middle">
                  <div class="uk-margin-small-right">
                    <i
                      class="fas fa-drafting-compass in-icon-wrap small circle uk-box-shadow-small"
                    ></i>
                  </div>
                  <div>
                ...
                <div class="uk-flex uk-flex-middle">
                  <div class="uk-margin-small-right">
                    <i
                      class="fas fa-book in-icon-wrap small circle uk-box-shadow-small"
                    ></i>
                  </div>
                  <div>
                ...
                <div class="uk-flex uk-flex-middle">
                  <div class="uk-margin-small-right">
                    <i
                      class="fas fa-bolt in-icon-wrap small circle uk-box-shadow-small"
                    ></i>
                  </div>
                  <div>
                ...
                <div class="uk-flex uk-flex-middle">
                  <div class="uk-margin-small-right">
                    <i
                      class="fas fa-percentage in-icon-wrap small circle uk-box-shadow-small"
                    ></i>
                  </div>
                  <div>
    ...
    <div
      class="uk-section uk-section-muted in-padding-large-vertical@s in-profit-1"
    >
      <div class="uk-container">
            ...
            <div class="uk-child-width-1-2@s uk-child-width-1-2@m" data-uk-grid>
              <div class="uk-flex uk-flex-middle">
                <div class="uk-margin-right">
                  <img
                    src="../assets/img/in-profit-icon-1.svg"
                    alt="profit-icon"
                    width="72"
                    height="72"
                  />
              ...
              <div class="uk-flex uk-flex-middle">
                <div class="uk-margin-right">
                  <img
                    src="../assets/img/in-profit-icon-2.svg"
                    alt="profit-icon"
                    width="72"
                    height="72"
                  />
              ...
              <div class="uk-flex uk-flex-middle">
                <div class="uk-margin-right">
                  <img
                    src="../assets/img/in-profit-icon-3.svg"
                    alt="profit-icon"
                    width="72"
                    height="72"
                  />
              ...
              <div class="uk-flex uk-flex-middle">
                <div class="uk-margin-right">
                  <img
                    src="../assets/img/in-profit-icon-4.svg"
                    alt="profit-icon"
                    width="72"
                    height="72"
                  />
    ...
    <!-- section content begin -->
    <div
      class="banner-top uk-section uk-padding-large in-padding-large-vertical@s uk-background-contain in-profit-2"
    >
      <div class="uk-container">
        <div class="uk-grid uk-flex uk-flex-center">
          ...
          <div class="uk-width-5-6@m">
            ...
            >
                  ...
                  <div class="uk-child-width-1-2@m" data-uk-grid>
                    <div>
                      <div data-uk-margin>
                        <a
                          href="#"
                          class="download-btn uk-button in-button-app uk-margin-small-right"
                        >
                    ...
                    <div class="uk-visible@m">
                      <img
                        src="../assets/img/in-profit-mockup-1.png"
                        width="450"
                        height="203"
                        alt="profit-mockup"
                      />
              ...
              <div class="uk-width-1-1">
                <div
                  class="uk-grid uk-grid-divider uk-grid-match in-profit-tradestatus"
                  data-uk-grid
                >
                    ...
                    <div class="uk-flex uk-flex-left uk-flex-center@m">
                      <div class="uk-grid uk-grid-small uk-flex-middle">
                        <div class="uk-width-auto">
                          <i
                            class="fas fa-chart-line fa-2x in-icon-wrap circle primary-color"
                          ></i>
                        </div>
                  ...
                  <div class="uk-width-1-1 uk-width-expand@m uk-flex-middle">
                    <p class="uk-text-lead">
                      Trade & Invest in Stocks, Currencies, Indices, and
                      Commodities (CFDs).
                    </p>
                  </div>
                </div>
      ...
      <div class="uk-container uk-margin-small-bottom">
        <div class="uk-grid-large" data-uk-grid>
          <div class="uk-width-1-2@m">
            ...
            <p class="uk-text-lead">
              Excepteur occaeca cupidata non proident fugiat nulla pariatur
              quasi architecto beatae, sunt in culpa quila officia deserunt
              mollit anim id est aute laborum.
            </p>
          </div>
          <div class="uk-width-1-1">
            <div
              class="uk-child-width-1-2@s uk-child-width-1-4@m uk-margin-small-top"
              data-uk-grid
            >
              <div>
                ...
                <p>
                  Lorem ipsum dolor sit odin amet consectetur adipisicing elit.
                </p>
              </div>
              <div>
                <h1 class="uk-heading-bullet">
    ...
    <!-- section content begin -->
    <div
      class="uk-section uk-padding-large in-padding-large-vertical@s in-profit-4"
    >
      <div class="uk-container uk-margin-small-top uk-margin-medium-bottom">
        <div class="uk-grid uk-flex uk-flex-center" data-uk-grid>
          ...
          <div class="uk-width-1-1">
            <div
              class="uk-child-width-1-2@s uk-child-width-1-5@m in-profit-stockprice"
              data-uk-grid
            >
              <div>
                <div
                  class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill"
                >
                  <span class="uk-float-left">
                    <img
                      src="../assets/img/in-profit-ticker-1.svg"
                      alt="profit-ticker"
                      width="77"
                      height="20"
                    />
              ...
              <div>
                ...
                >
                  <span class="uk-float-left">
                    <img
                      src="../assets/img/in-profit-ticker-2.svg"
                      alt="profit-ticker"
                      width="77"
                      height="20"
                    />
              ...
              <div>
                ...
                >
                  <span class="uk-float-left">
                    <img
                      src="../assets/img/in-profit-ticker-3.svg"
                      alt="profit-ticker"
                      width="77"
                      height="20"
                    />
              ...
              <div>
                ...
                >
                  <span class="uk-float-left">
                    <img
                      src="../assets/img/in-profit-ticker-4.svg"
                      alt="profit-ticker"
                      width="77"
                      height="20"
                    />
              ...
              <div class="uk-visible@m">
                ...
                >
                  <span class="uk-float-left">
                    <img
                      src="../assets/img/in-profit-ticker-5.svg"
                      alt="profit-ticker"
                      width="77"
                      height="20"
                    />
          ...
          <div class="uk-width-5-6@m">
            <div class="uk-grid-large uk-flex-middle" data-uk-grid>
              <div class="uk-width-auto@m">
                <h4 class="uk-margin-remove-bottom uk-text-primary">
                  Ready to trade?
                </h4>
              ...
              <div class="uk-width-expand@m">
                <form class="uk-grid-small" data-uk-grid>
                  ...
                  <div class="uk-width-1-1 uk-width-auto@m">
                    <button
                      class="uk-button uk-button-primary uk-border-rounded uk-width-expand"
                    >
                      Open Account
                    </button>
                  </div>
        ...
        <div class="uk-grid" data-uk-grid>
          <div class="uk-width-1-1">
            <div
              ...
              data-businessunit-id="561d886b0000ff0005844fd6"
              data-style-height="28px"
              data-style-width="100%"
              data-theme="light"
            >
              <a
                href="https://uk.trustpilot.com/review/pepperstone.com"
                target="_blank"
