          ...
          >
            <div class="uk-flex uk-flex-left">
              <div class="uk-margin-right">
                <i
                  class="fas fa-leaf fa-lg in-icon-wrap circle primary-color"
                ></i>
              </div>
              <div>
                <h3>Philosophy</h3>
            ...
            <div class="uk-flex uk-flex-left">
              <div class="uk-margin-right">
                <i
                  class="fas fa-hourglass-end fa-lg in-icon-wrap circle primary-color"
                ></i>
              </div>
              <div>
                <h3>History</h3>
            ...
            <div class="uk-flex uk-flex-left">
              <div class="uk-margin-right">
                <i
                  class="fas fa-flag fa-lg in-icon-wrap circle primary-color"
                ></i>
              </div>
              <div>
                <h3>Culture</h3>
        ...
        <div class="uk-grid">
          <div class="uk-width-1-1">
            <div
              ...
              style="background-image: url(img/in-team-background-1.png)"
                    ...
                    <div>
                      ...
                      <div>
                        <a class="uk-link-muted" href="#"
                          ><i
                            class="fab fa-facebook-f uk-margin-small-right"
                          ></i
                        ></a>
                        <a class="uk-link-muted" href="#"
            ...
            <div class="uk-grid uk-flex uk-flex-middle" data-uk-grid>
              <div class="uk-width-1-2@m">
                ...
                <h1 class="uk-margin-medium-bottom">
                  We always ready<br />for a
                  <span class="in-highlight">challenge.</span>
                </h1>
                <a
                  href="#"
                  class="uk-button uk-button-primary uk-border-rounded"
                  >Learn more<i
                    class="fas fa-chevron-circle-right fa-xs uk-margin-small-left"
                  ></i
                ></a>
              </div>
              <div class="uk-width-1-2@m">
                <div class="uk-margin-large" data-uk-grid>
                  ...
                  <div class="uk-width-expand@m">
                    ...
                    <p>
                      Reprehenderit qui in svoluptate velit esse quam molestiae
